...
public class Solution
{
    ...
    static String[] signals = {"зеленый", "желтый", "красный"};
...
//        double timeInPeriod = time - minPeriod * (int)(time/minPeriod);
        double timeInPeriod = time % 5;

        if(timeInPeriod >= 0 && timeInPeriod < 3) {
            System.out.println("зеленый");
        } else if(timeInPeriod >= 3 && timeInPeriod < 4) {
